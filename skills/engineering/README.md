...
- **[setup-matt-pocock-skills-safe](./setup-matt-pocock-skills-safe/SKILL.md)** — Initialize `.workspace/` (git-ignored) in NDA-governed company repos. Writes agent config, adds `.workspace/` to `.gitignore`, and updates `CLAUDE.md`/`AGENTS.md`. Run before first use of any engineering skill in repos where GitLab/GitHub access is prohibited.
