...
The issue tracker config should have been provided to you — run `/setup-matt-pocock-skills-safe` if `.workspace/agents/issue-tracker.md` is missing.
...
3. A PRD/spec file under `.workspace/issues/` matching the branch name or feature.
